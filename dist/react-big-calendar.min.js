!(function(e, t) {
  ...
  ;(es.propTypes = {}),
    (es.defaultProps = { dragThroughEvents: !0, timeslots: 2 })
  var ts,
    ns = (function(e) {
      function t() {
  ...
  function os(e) {
    if (((!ts && 0 !== ts) || e) && jt) {
      ...
      ;(t.style.position = 'absolute'),
        ...
        (ts = t.offsetWidth - t.clientWidth),
    ...
    return (
      ...
      (n.render = function() {
        var e = this,
          ...
          b = void 0 === y ? is : y,
          w = {}
        m && (w[o ? 'marginLeft' : 'marginRight'] = os() + 'px')
    ...
    return (
      ...
      (t.prototype.render = function() {
        var e = this.props,
          ...
          o = s(e, ['date']),
          i = t.range(n)
        return r.createElement(cs, a({}, o, { range: i, eventOffset: 10 }))
      }),
      t
    )
  })(r.Component)
  ...
  var us = (function(e) {
    ...
    return (
      ...
      (t.prototype.render = function() {
        ...
        return r.createElement(cs, a({}, o, { range: i, eventOffset: 15 }))
      }),
      t
    )
  })(r.Component)
  function fs(e, t) {
    return us.range(e, t).filter(function(e) {
      return -1 === [6, 0].indexOf(e.getDay())
    })
  }
  ;(us.propTypes = {}),
    (us.defaultProps = cs.defaultProps),
    (us.navigate = function(e, t) {
      switch (t) {
        case T.PREVIOUS:
          return X(e, -1, 'week')
        case T.NEXT:
    ...
    return (
      ...
      (t.prototype.render = function() {
        var e = this.props,
          ...
          n = s(e, ['date']),
          o = fs(t, this.props)
        return r.createElement(cs, a({}, n, { range: o, eventOffset: 15 }))
      }),
      t
    )
  })(r.Component)
  ...
  ;(ds.propTypes = {}),
    (ds.defaultProps = cs.defaultProps),
    (ds.range = fs),
    (ds.navigate = us.navigate),
            ...
            if (n.tbodyRef.current) {
              ...
              if (t) {
                var r,
                  ...
                  a = n._widths || []
                ;(n._widths = [rs(t.children[0]), rs(t.children[1])]),
                  ...
                  i
                    ...
                    : (function(e, t) {
                        e.classList
                          ...
                          ? (e.className = ps(e.className, t))
                          : e.setAttribute(
                              'class',
                              ps((e.className && e.className.baseVal) || '', t)
                            )
  ...
  ;(ms.propTypes = {}),
    (ms.defaultProps = { length: 30 }),
    (ms.range = function(e, t) {
      var n = t.length
      return {
        start: e,
        end: X(e, void 0 === n ? ms.defaultProps.length : n, 'day'),
      }
    }),
    (ms.navigate = function(e, t, n) {
      var r = n.length,
        o = void 0 === r ? ms.defaultProps.length : r
      switch (t) {
        case T.PREVIOUS:
          return X(e, -o, 'day')
        case T.NEXT:
    ...
    (ms.title = function(e, t) {
      var n = t.length,
        r = void 0 === n ? ms.defaultProps.length : n,
        o = t.localizer,
        i = X(e, r, 'day')
      return o.format({ start: e, end: i }, 'agendaHeaderFormat')
    })
  var vs = (((hs = {})[x.MONTH] = Da),
  (hs[x.WEEK] = us),
  (hs[x.WORK_WEEK] = ds),
  (hs[x.DAY] = ls),
  (hs[x.AGENDA] = ms),
  ...
  function gs(e, t) {
    ...
    switch (((e = 'string' == typeof e ? vs[e] : e), n)) {
      case T.TODAY:
        r = o || new Date()
        break
      case T.DATE:
        ...
        return r.createElement(
          ...
          r.createElement(
            ...
            r.createElement(
              ...
              {
                type: 'button',
                onClick: this.navigate.bind(null, T.PREVIOUS),
                id: 'nagigate-left',
              },
              t.previous
            ),
            r.createElement(
              ...
              {
                type: 'button',
                onClick: this.navigate.bind(null, T.NEXT),
                id: 'nagigate-right',
              },
              t.next
            )
  ...
  function _s(e, t, n) {
    var r = e[t]
    ;(Es.call(e, t) && Se(r, n) && (void 0 !== n || t in e)) || ws(e, t, n)
  }
  function Os(e, t, n, r) {
    var o = !n
    n || (n = {})
    for (var i = -1, a = t.length; ++i < a; ) {
      ...
      void 0 === c && (c = e[s]), o ? ws(n, s, c) : _s(n, s, c)
    }
    return n
  }
  ...
  function oc(e, t, n) {
    ...
    switch (t) {
      ...
      case Us:
        return (
          ((i = new (o = e).constructor(o.source, Ls.exec(o))).lastIndex =
            o.lastIndex),
          i
        )
      case Ys:
        return new a()
      case $s:
        return (r = e), Is ? Object(Is.call(r)) : {}
    }
  }
    ...
    if (lc(e))
      return (
        e.forEach(function(r, o) {
          a.set(o, Ec(r, t, n, o, e, i))
        }),
        a
      )
    var h = l ? (c ? Rs : ri) : c ? keysIn : ni,
      m = u ? void 0 : h(e)
    return (
      bs(m || e, function(r, o) {
        m && (r = e[(o = r)]), _s(a, o, Ec(r, t, n, o, e, i))
      }),
      a
    )
  }
  ...
  ;(wc[vc] = wc['[object Array]'] = wc['[object ArrayBuffer]'] = wc[
    '[object DataView]'
  ] = wc['[object Boolean]'] = wc['[object Date]'] = wc[
    '[object Float32Array]'
  ] = wc['[object Float64Array]'] = wc['[object Int8Array]'] = wc[
    '[object Int16Array]'
  ] = wc['[object Int32Array]'] = wc['[object Map]'] = wc[
    '[object Number]'
  ] = wc[bc] = wc['[object RegExp]'] = wc['[object Set]'] = wc[
    '[object String]'
  ] = wc['[object Symbol]'] = wc['[object Uint8Array]'] = wc[
    '[object Uint8ClampedArray]'
  ] = wc['[object Uint16Array]'] = wc['[object Uint32Array]'] = !0),
    (wc['[object Error]'] = wc[gc] = wc['[object WeakMap]'] = !1)
  var Oc = '[object Object]',
    Sc = Function.prototype,
    Mc = Object.prototype,
    Dc = Sc.toString,
    Tc = Mc.hasOwnProperty,
    xc = Dc.call(Object)
  function jc(e) {
    return (function(e) {
      if (!Ze(e) || Fe(e) != Oc) return !1
      var t = Cs(e)
      if (null === t) return !0
      var n = Tc.call(t, 'constructor') && t.constructor
      return 'function' == typeof n && n instanceof n && Dc.call(n) == xc
    })(e)
      ? void 0
      : e
  }
  ...
  var Cc = (function(e) {
      ...
      ;(t = Hi(t, function(t) {
        ...
        Os(e, Rs(e), n),
        r && (n = Ec(n, 7, jc))
      for (var o = t.length; o--; ) _c(n, t[o])
      return n
    }),
    kc = Object.prototype,
    Rc = kc.hasOwnProperty,
    Pc = Xa(function(e, t) {
      e = Object(e)
      var n = -1,
        r = t.length,
      ...
      for (o && Ke(t[0], t[1], o) && (r = 1); ++n < r; )
        for (var i = t[n], a = Ds(i), s = -1, c = a.length; ++s < c; ) {
          var l = a[s],
            u = e[l]
          ;(void 0 === u || (Se(u, kc[l]) && !Rc.call(e, l))) && (e[l] = i[l])
        }
      return e
    })
  var Ac = function(e) {
      ...
      return (
          ...
          return Array.isArray(o)
            ? (function(e, t, n) {
                ...
                if (((t = ra(t)), null == n)) {
                  ...
                  n = o ? (r ? new i() : []) : Ie(e) && Ue(i) ? ac(Cs(e)) : {}
                }
                return (
                  (o ? bs : Aa)(e, function(e, r, o) {
                    return t(n, e, r, o)
                  }),
                  n
                )
        ...
        (t.handleNavigate = function(e, n) {
          var r = t.props,
            ...
            d = c()
          l(
            (i = gs(f, a({}, u, { action: e, date: n || i || d, today: d }))),
            o,
            e
          ),
  ...
  var Ic = (function e(t, n, o) {
    ...
    })(Fc, { view: 'onView', date: 'onNavigate', selected: 'onSelectEvent' }),
    zc = function(e, t, n) {
      var r = e.start,
        o = e.end
  ...
  var Hc = function(e, t, n) {
    ...
    Vc = {
      ...
      dayFormat: 'ddd dd/MM',
      weekdayFormat: 'ddd',
      selectRangeFormat: Hc,
      eventTimeRangeFormat: Hc,
      eventTimeRangeStartFormat: function(e, t, n) {
        var r = e.start
  ...
  var $c = { eventWrapper: i, timeSlotWrapper: i, dateCellWrapper: i }
  ;(e.Calendar = Ic),
    (e.DateLocalizer = R),
    (e.Navigate = T),
    (e.Views = x),
