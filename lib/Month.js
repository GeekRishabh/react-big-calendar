...
var MonthView =
  ...
  (function(_React$Component) {
    ...
    function MonthView() {
      ...
      _this.handleCalendarNavigationClick = (0, _lodash.debounce)(
        function(deltaY) {
          if (deltaY > 0) {
            // prev month
            _this.navigateLeft()
      ...
      _this.handleCalendarNavigationMobile = (0, _lodash.debounce)(
        function(deltaY) {
      ...
      _this.touchMoveHandler = function(e) {
        ...
        _this.handleCalendarNavigationMobile(_this.startTouch - _this.endTouch)
      }
